...
public class Conexao {
    ...
    public Conexao() {
        // String de conexao
        this.url = "jdbc:mysql://127.0.0.1:3306/DevWeb?useSSL=false&useTimezone=true&serverTimezone=UTC";
        this.usuario = "luh";   // Informe o usuario e senha
        this.senha = "Lucim@ra"; // do seu banco de dados
