...
%>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><a class="nav-link"
						href="telas/Principais/quemSomos.jsp">Quem Somos</a></li>
	...
	<nav id="nav">
		<ul class="main">
			<li><a 
				href="telas/Filtros/servicoAlimento.jsp?Alimentos=Alimentos"> Alimentos</a></li>
			<li><a 
				href="telas/Filtros/servicoBebidas.jsp?Bebidas=Bebidas">Bebidas</a></li>
			<li><a href="telas/Filtros/servicoBebe.jsp?Infantil=Infantil">Infantil</a></li>
			<li><a 
				href="telas/Filtros/servicoHigiene.jsp?Higiene=Higiene">Higiene</a></li>
			<li><a
	...
	<div class="container bg-teste col-12" style="margin-top: 15px">
		<div class="row">
			<div class="col-12">
				<img src="telas/Imagens/Logotipo5.PNG" class="col-12">
			</div>
			...
			<div class="col-12 col-lg-4 col-md-6 col-sm-6 img1">
				<form action="CompraControlador" method="post">
					...
					<a href="telas/servicoAlimento.jsp"><input
						...
						src="telas/Imagens/Alimentos.png"></a>
				</form>
			</div>
			<div class="col-12 col-lg-4 col-md-6 col-sm-6 img1">
				<form action="CompraControlador" method="post">
					...
					<a href="telas/servicoHigiene.jsp"><input
						...
						src="telas/Imagens/Higiene.png"></a>
				</form>
			</div>
			...
			<div class="col-12 col-lg-4 col-md-6 col-sm-6 img1">
				<form action="" method="post">
					...
					<a href="telas/servicoLimpeza.jsp"><input
						style="margin-top: 20px" type="image" name="imagem" id="imagem"
						src="telas/Imagens/Limpeza.png"></a>
				</form>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-12 col-lg-3 col-md-3 col-sm-3">
				<a
					href="telas/CadProdutoFornecedor/exibe1.jsp?produto_id=<%=produto4.getId()%>">
					<img src="telas/Imagens/<%=produto4.getFoto()%>">
				</a>

				<p style="margin-right: 120px" class="text-center ">
					<b><%=produto4.getNomeProduto()%></b>
				</p>
			</div>
			<%
			}
	...
	<div class="container col-12 ">
		<div class="row">
			<div class="col-12 ">
				<img src="telas/Imagens/Rodape.png" class="col-12 ">
			</div>
		</div>
	</div>
</body>
