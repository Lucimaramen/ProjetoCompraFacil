...
Alimentos = request.getParameter("Alimentos");

DaoProduto daoCategoria1  = new DaoProduto();

	List<Produto> listaCategoria = daoCategoria1.selectCat(Alimentos);
...
%>
	...
	<nav id="nav">
			<ul class="main">
			<li><a 
				href="servicoAlimento1.jsp?Alimentos=Alimentos"> Alimentos</a></li>
			<li><a 
