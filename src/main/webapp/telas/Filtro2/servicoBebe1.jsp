...
String Infantil = null;

	Infantil = request.getParameter("Infantil");

DaoProduto daoCategoria3  = new DaoProduto();

	List<Produto> listaCategoria = daoCategoria3.selectCatC(Infantil);
...
%>
	...
	<nav id="nav">
			<ul class="main">
			<li><a 
				href="servicoAlimentos1.jsp?Alimentos=Alimentos"> Alimentos</a></li>
			<li><a 
				href="servicoBebidas.jsp?Bebidas=Bebidas">Bebidas</a></li>
			<li><a href="servicoBebe1.jsp?Infantil=Infantil">Infantil</a></li>
			<li><a 
				href="servicoHigiene1.jsp?Higiene=Higiene">Higiene</a></li>
			<li><a
				href="servicoLimpeza1.jsp?Limpeza=Limpeza">Limpeza</a></li>
			<li><a 
				href="servicoSaude.jsp?Saude=Saude">Saúde</a></li>
		</ul>
	</nav>
