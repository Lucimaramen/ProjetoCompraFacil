...
<%
DaoProduto dao90 = new DaoProduto();
List<Produto> listaProduto = dao90.select();
...
<div class="menu">
	...
	<nav id="nav">
			<ul class="main">
			<li><a 
				href="../Filtro2/servicoAlimentos1.jsp?Alimentos=Alimentos"> Alimentos</a></li>
			<li><a 
				href="../Filtro2/servicoBebidas.jsp?Bebidas=Bebidas">Bebidas</a></li>
			<li><a href="../Filtro2/servicoBebe1.jsp?Infantil=Infantil">Infantil</a></li>
			<li><a 
				href="../Filtro2/servicoHigiene1.jsp?Higiene=Higiene">Higiene</a></li>
			<li><a
				href="../Filtro2/servicoLimpeza1.jsp?Limpeza=Limpeza">Limpeza</a></li>
			<li><a 
				href="../Filtro2/servicoSaude.jsp?Saude=Saude">Saúde</a></li>
		</ul>
	</nav>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<%
			for (Produto produto7 : listaProduto) {
			%>
			<div class="col-12 col-lg-3 col-md-3 col-sm-3">
				<a href="../CadProdutoFornecedor/exibe.jsp?produto_id=<%=produto7.getId() %>" > <img
					src="../Imagens/<%=produto7.getFoto()%>"></a>

				<p style="margin-right: 120px" class="text-center ">
					<b><%=produto7.getNomeProduto() %></b>
				</p>
			</div>
			<%
			}
